...
class Yolo:
    ...
    def detect(self, label, frame, thresh=0.5, hier_thresh=0.5, nms=0.45):
        ...
        for j in range(num):
            for i in range(self.meta.classes):
                if self.class_names[i] == label and detections[j].prob[i] > 0:
                    b = detections[j].bbox

                    b.x = (b.x-b.w/2) / im_width
                    b.y = (b.y-b.h/2)/ im_height
                    b.w = b.w / im_width
                    b.h = b.h / im_height
...
# net = Yolo('cfg/yolov4-custom.cfg', 'weights/yolov4-custom_best.weights', 'meta/obj.data', 0, 1)
